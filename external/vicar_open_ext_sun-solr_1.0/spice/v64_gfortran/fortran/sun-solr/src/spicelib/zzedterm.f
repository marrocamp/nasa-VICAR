...
C
C     Find bounds on the angular size of the target as seen
C     from the source.
C
      MINANG = ASIN (  MIN( RMAX/D, 1.D0 )  )
      MAXANG = ASIN (  MIN( RMIN/D, 1.D0 )  )

C
C     Let the inverse of the ellipsoid-light source vector be the
