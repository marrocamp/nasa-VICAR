C$Procedure      SPKS02 ( S/P Kernel, subset, type 2 )
...
C$ Abstract
C
C     Extract a subset of the data in a SPK segment of type 2
...
C$ Particulars
C
C     The exact structure of a segment of data type 2 is detailed in
