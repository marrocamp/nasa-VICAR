...
C
C
C     First we divide X by 16 until we reach a value for which
C     convergence of the Taylor Series is relatively rapid.
C
      Y    = X
      DIVS = 0
...
C
C     Now using the 16th angle formulae, compute C0 through C3 at X.
C
      DO I = 1, DIVS
