...
C$ Abstract
C
C     Given a matrix, construct the matrix whose rows are the 
C     columns of the first divided by the length squared of the
C     the corresponding columns of the input matrix.
C
C$ Disclaimer
C
