...
C     interpolants at NEWX.  We'll also evaluate the derivatives of 
C     these interpolants at NEWX and save the results in the second
C     column of WORK.  Because the derivative computations depend on the
