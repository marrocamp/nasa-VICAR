...
C         error SPICE(DAFNOSEARCH) is signalled.
C
...
C         the current DAF, the error SPICE(DAFNOSEARCH) is signalled.
C
...
C         SPICE(NOCURRENTARRAY) is signalled.  There is no current
