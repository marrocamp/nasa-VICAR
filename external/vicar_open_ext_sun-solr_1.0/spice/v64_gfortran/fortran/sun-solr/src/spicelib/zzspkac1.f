C$Procedure ZZSPKAC1 ( S/P Kernel, aberration corrected state )
 
      SUBROUTINE ZZSPKAC1 ( TARG, ET, REF, ABCORR, OBS, STARG, LT, DLT )
...
C
      CALL ZZSPKGO1 ( OBS, ET, REF, SSB, SSBOBS, SSBLT )
...
C        barycenter at ET +/- DELTA.
         ...
         DO I = 1, 2
            ...
            CALL ZZSPKGO1 ( OBS, T, REF, SSB, STOBS(1,I), LTSSB )
...
C     
      CALL ZZSPKAS1 ( TARG,   ET,  REF,   ABCORR, 
