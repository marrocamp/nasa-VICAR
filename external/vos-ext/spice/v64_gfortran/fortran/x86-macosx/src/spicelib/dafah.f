...
C
C     1) NAIF Document 167.0, "Double Precision Array Files (DAF)
C        Specification and User's Guide"
C
C     2) Sun Fortran Programmer's Guide
C
C     3) Microsoft Fortran Optimizing Compiler User's Guide
C
C     4) Lahey F77 EM/32 Language Reference Manual, page 144
C
C     5) Language Systems FORTRAN Reference Manual, Version 1.2,
C        page 12-7
C
...
C
C     Open a new DAF for subsequent write requests.
C     Obsolete: This routine has been superceded by DAFONW. It is
