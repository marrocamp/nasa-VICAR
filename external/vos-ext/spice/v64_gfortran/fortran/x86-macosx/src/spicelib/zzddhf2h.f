...
C     FTHAN,
C     FTNAM,
C     FTRTM      are the arrays respectively containing the absolute
C                value of the handle, access method, architecture,
C                binary file format, handle, name, and RTRIM columns of
C                the file table.
C
...
C        its UNIT matche UTLUN(UINDEX).
C
