C$Procedure      ZZTIME ( Private --- time parsing utilities )
...
C
      ...
      INTEGER               BEGS ( WDSIZE )
      INTEGER               ENDS ( WDSIZE )
      INTEGER               PBEGS( WDSIZE )
      INTEGER               PENDS( WDSIZE )
...
C$Procedure      ZZCMBT ( Private --- combine tokens )
...
C$Procedure      ZZGREP ( Private --- get representation )
...
C$Procedure      ZZISPT ( Private --- is pair of tokens )
...
C$Procedure      ZZIST ( Private --- is there a token )
...
C$Procedure      ZZNOTE ( Private --- note the existence and remove )
...
C$Procedure      ZZREMT ( Private --- remove token )
...
C$Procedure      ZZSUBT ( Private --- substitute tokens )
...
C$ Particulars
C
C     This routine searchs for the first instance of a specified
...
C$Procedure      ZZTOKNS ( Private --- Time Tokens )
...
C$Procedure      ZZUNPCK ( Private --- Unpack a time string )
...
C$Procedure      ZZVALT ( Private --- Value Based Tokens )
