...
C                               corrections.  This is the same as LT
C                               corrections but with further iterations
C                               to a converged Newtonian light time
C                               solution.  Given that relativistic
C                               effects may be as large as the higher
C                               accuracy achieved by this computation,
C                               this is correction is seldom worth the
C                               additional computations required unless
C                               the user incorporates additional
C                               relativistic corrections.  Light
C                               time corrections are applied as in the
C                               'LT' case.
C                      
C                    'CN+S'     Converged Newtonian light time
C                               corrections and stellar aberration.
C                               Light time and stellar aberration 
C                               corrections are applied as in the
C                               'LT+S' case.
C
C
