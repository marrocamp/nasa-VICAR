...
C                                            radii
C           naif0009.tls                     Leapseconds kernel
...
C     
C           KERNELS_TO_LOAD = ( 
C                   '/kernels/gen/lsk/naif0008.tls'
C                   '/kernels/gen/spk/de414.bsp'
C                   '/kernels/gen/pck/pck00008.tpc' 
C                   '/kernels/gen/spk/earthstns_itrf93_050714.bsp',
C                   '/kernels/gen/fk/earth_topo_050714.tf',
C                   '/kernels/gen/pck/earth_000101_080120_071029.bpc',
C                             )
C
C     Example(1):
C
...
C
C        Edit the GFPOSC_EX program, assign
C
C           RELATE = 'ABSMIN' 
C
C        The program outputs:
...
C
C        Edit the GFPOSC_EX program above, assign:
C
C           RELATE = '='
