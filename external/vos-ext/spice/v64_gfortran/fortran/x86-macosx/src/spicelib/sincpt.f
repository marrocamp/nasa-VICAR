...
C    C        compose two transformations: that from IAU_MARS to
C    C        J2000 at TRGEPC, followed by the transformation from
C    C        J2000 to MRO_HIRISE_LOOK_DIRECTION at ET.
C    C        (We could use any other inertial frame in place
C    C        of J2000; the result would be the same.)
C    C
...
C
C             CALL PXFORM ( 'IAU_MARS', 'J2000', TRGEPC, R1 )
C             CALL PXFORM ( 'J2000',    HIREF,   ET,     R2 )
C
C             CALL MXM ( R2,    R1,     XFORM  )
