...
C                 existing output file was requested. If approprite
...
C
     ...
     .   //             'numeric code of the object or NORAD '
     .   //             's/c code'
         MESSGE(  8 ) = ' or'
...
C
     ...
     .        IOUTYP .NE. 17 ) THEN
            ...
            CALL SETMSG ( 'Output SPK type ''#'' prodived on the '   //
