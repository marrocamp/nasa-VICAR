...
C         an error is signalled by a routine that this routine calls.
C
C$ Files
C
C     None.
...
C
C     Start off with FOUND set to false.  This guards against FOUND
C     being left unchanged from a previous call if any errors are
C     detected.
C
      FOUND = .FALSE.
