C$Procedure ZZSPKGO1 ( S/P Kernel, geometric state )
 
      SUBROUTINE ZZSPKGO1 ( TARG, ET, REF, OBS, STATE, LT )
...
C                 the SPICELIB subroutine ZZFRMCH1.
C
...
C$ Particulars
C
C     ZZSPKGO1 computes the geometric state, T(t), of the target
...
C               ET = BEGIN + I*DELTA
C
C               CALL ZZSPKGO1 ( MOON, ET, 'J2000', EARTH, STATE, LT )
C
...
C
C     2) The ephemeris files to be used by ZZSPKGO1 must be loaded
C        by SPKLEF before ZZSPKGO1 is called.
C
...
C
               ...
               ELSE
                  ...
                  CALL ZZFRMCH1( TFRAME(CHLEN), TMPFRM,   ET,   STXFRM )
...
C
            ...
            ELSE
               ...
               CALL ZZFRMCH1 ( CFRAME, TMPFRM, ET,   STXFRM )
...
C
      ...
      DO I = 2, CTPOS-1
         ...
         ELSE
            ...
            CALL ZZFRMCH1 ( TFRAME(I),  TFRAME(I+1), ET,  STXFRM       )
...
C
         ...
         ELSE
            ...
            CALL ZZFRMCH1 ( CFRAME, REFID, ET,  STXFRM )
...
C        ZZFRMCH1 to get things into a common frame.
C
      ...
      ELSE
C
C        Use the more general routine ZZFRMCH1 to make the
C        transformation.
C
         CALL ZZFRMCH1 ( TFRAME(CTPOS),  CFRAME,          ET,  STXFRM )
