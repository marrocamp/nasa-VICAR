...
C
            CALL ZZGFREL ( UDSTEP,       UDREFN,          ZZGFCOSD,
     .                     ZZGFCOSL,     ZZGFCOSG,        ZZGFCOUR,
     .                     '=',          PRXVAL,          LOCTOL,
     .                     0.D0,         CNFINE,          MW,
     .                     NW,           WORK,            RPT,
...
C
            CALL ZZGFREL ( UDSTEP,       UDREFN,          ZZGFCOCD, 
     .                     ZZGFCOCL,     ZZGFCOCG,        ZZGFCOUR,
     .                     '=',          PRXVAL,          LOCTOL, 
     .                     0.D0,         CNFINE,          MW,
     .                     NW,           WORK,            RPT,
     .                     UDREPI,       UDREPU,          UDREPF,
...
C
            ...
            CALL ZZGFCOIN ( VECDEF, METHOD, TARGET,   
     .                      REF,    ABCORR, OBSRVR, DREF,    
     .                      DVEC,   PRXSYS, PRXCRD, 0.D0  )

            CALL ZZGFREL (  UDSTEP,    UDREFN,              ZZGFCODC, 
     .                      ZZGFCOLT,  ZZGFCOG,             ZZGFCOUR,
     .                      UOP,       0.D0,                LOCTOL, 
     .                      0.D0,      WORK(LB,S),          MW,   
     .                      NW,        WORK,                RPT,
     .                      UDREPI,    UDREPU,              UDREPF,
