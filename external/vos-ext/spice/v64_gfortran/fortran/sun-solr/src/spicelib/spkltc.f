C$Procedure SPKLTC ( S/P Kernel, light time corrected state )
...
C  
      CALL SPKGEO ( TARG,   ET,    REF, SSB,  SSBTRG, SSBLT )
...
C
      ...
      DO I = 1, NUMITR
         ...
         CALL SPKGEO ( TARG,   ET + LTSIGN*LT, REF, SSB, SSBTRG, SSBLT )
         CALL VSUBG  ( SSBTRG, STOBS,          6,   STARG              )
