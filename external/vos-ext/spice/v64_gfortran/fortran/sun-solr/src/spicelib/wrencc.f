...
C     On some supported environments, ICHAR is not sufficient to
C     produce the desired results.  This, however, is not the case
C     with this particular environment.
C
      ZZICHR(CARG) = ICHAR(CARG)
