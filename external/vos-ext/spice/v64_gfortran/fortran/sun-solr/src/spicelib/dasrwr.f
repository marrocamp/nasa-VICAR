...
C         SPICE(INDEXOUTOFRANGE) will be signalled.  The output argument
...
C
C     4)  If FIRST or LAST is not in the range [1, NWD], the error
C         SPICE(INDEXOUTOFRANGE) will be signalled.  The indicated
C         record will not be modified.
C
C     5)  If FIRST > LAST, this routine will return without modifying
...
C     become out of synch with the file they operate upon.
C
