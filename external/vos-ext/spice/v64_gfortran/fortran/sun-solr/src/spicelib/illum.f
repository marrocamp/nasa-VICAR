...
C                                     corrections.  This is the same as
C                                     LT corrections but with further
C                                     iterations to a converged
C                                     Newtonian light time solution.
C                                     Given that relativistic effects
C                                     may be as large as the higher
C                                     accuracy achieved by this
C                                     computation, this is correction
C                                     is seldom worth the additional
C                                     computations required unless the
C                                     user incorporates additional
C                                     relativistic corrections.  Both
C                                     the state and rotation of the
C                                     target body are corrected for
C                                     light time.
C
C                          'CN+S'     Converged Newtonian light time
C                                     corrections and stellar
C                                     aberration. Both the state and
...
C 
      CALL BODS2C ( TARGET, TRGCDE, FOUND )
     ...
     .   //            'version of the SPICE Toolkit. '           )
      ...
      CALL BODS2C ( OBSRVR, OBSCDE, FOUND )
