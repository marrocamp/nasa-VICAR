C$Procedure      FRMCHG (Frame Change)
...
C
         CALL FRMGET ( FRAME(NODE), ET, TRANS(1,1,NODE), RELTO, FOUND  )
...
C
            CALL FRMGET ( THIS,  ET, TRANS2(1,1,PUT), RELTO, FOUND  )
...
C
            CALL FRMGET ( THIS,  ET, TEMPXF, RELTO,  FOUND  )
