...
C     VAX, VAX FORTRAN
C     Sun, Sun FORTRAN
C     IBM PC, Microsoft FORTRAN, Lahey EM/32 FORTRAN
C     Macintosh, Language Systems FORTRAN
C     HP-UX 9000/750, FORTRAN/9000 Series 700 computers
C     Silicon Graphics, IRIX OS, SGI FORTRAN 77
C     DEC Alpha, OSF/1, DEC FORTRAN-77
C     NeXT, Mach OS, Absoft Fortran 77
C
      CHBASE = 256
