...
C
C     Intialize our head and tail character sets.
C
...
C        is signalled.  The set of allowed identifier characters is not
C        modified.
C
C$ Files
C
...
C
C     Intialize our head and tail character sets, every time.
C
      CALL SSIZEI ( MAXCHR, HEADC )
      CALL SSIZEI ( MAXCHR, TAILC )
