...
C      can do the same.
C
C      Additionally, when an error is signalled in 'RETURN' mode,
C      no further errors can be signalled until the error condition
...
C
      ...
      RETURN  =  ( ACTION .EQ. IRETRN ) .AND. FAILED()
