...
C
            CALL ET2STR( CMPWIN(I),   TIMFMT, SCLKID, HLPSTR )
            CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )

            CALL ET2STR( CMPWIN(I+1), TIMFMT, SCLKID, HLPSTR )
            CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
...
C
            CALL ET2STR( EPOCH(I), TIMFMT, SCLKID, HLPSTR )
            CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
...
C
               DO J = 1, 3
                  DO K = 1, 3
                     CALL DPSTRP( MDIFF(J,K), 14, HLPSTR )
                     CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
                  END DO
               END DO
...
C
               ...
               DO J = 1, 4
                  CALL DPSTRP( QDIFFS(J), 14, HLPSTR )
                  CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
               END DO
...
C
               ...
               DO J = 1, 4
                  CALL DPSTRP( QDIFFO(J), 14, HLPSTR )
                  CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
               END DO
...
C
               ...
               DO J = 1, 3
                  CALL DPSTRP( AVDIFF(J), 14, HLPSTR )
                  CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
               END DO
...
C
               IF ( EQSTR( DIFTYP, DAAVAL ) ) THEN
                  CALL DPSTRP( VNORM( AVDIFF ), 14, HLPSTR )
                  CALL REPMC ( DMPSTR, '#', HLPSTR, DMPSTR )
               END IF
...
C
            CALL DPSTRP( RANMAX, 14, HLPSTR )
            CALL REPMC ( INFMSG( 6 ), '#', HLPSTR, INFMSG( 6 ) )

            CALL DPSTRP( RANAV,  14, HLPSTR )
            CALL REPMC ( INFMSG( 6 ), '#', HLPSTR, INFMSG( 6 ) )
...
C
            IF ( AVFLG ) THEN
               ...
               CALL DPSTRP( AVDMAX, 14, HLPSTR )
               CALL REPMC ( INFMSG(  7 ), '#', HLPSTR, INFMSG(  7 ) )

               CALL DPSTRP( AVDAV,  14, HLPSTR )
               CALL REPMC ( INFMSG(  7 ), '#', HLPSTR, INFMSG(  7 ) )
...
C
            CALL DPSTRF( RANAV,  14, 'F', HLPSTR )
            CALL REPMC ( INFMSG(  4 ), '#', HLPSTR, INFMSG(  4 ) )

            CALL DPSTRF( RANRMS, 14, 'F', HLPSTR )
            CALL REPMC ( INFMSG( 11 ), '#', HLPSTR, INFMSG( 11 ) )

            CALL DPSTRF( RANMAX, 14, 'F', HLPSTR )
            CALL REPMC ( INFMSG( 18 ), '#', HLPSTR, INFMSG( 18 ) )

            CALL DPSTRF( RANMET, 14, 'F', HLPSTR )
...
C
            IF ( AVFLG ) THEN
               ...
               CALL DPSTRF( AVDAV,  14, 'F', HLPSTR )
               CALL REPMC ( INFMSG(  6 ), '#', HLPSTR, INFMSG(  6 ) )

               CALL DPSTRF( AVDRMS,  14, 'F', HLPSTR )
               CALL REPMC ( INFMSG( 13 ), '#', HLPSTR, INFMSG( 13 ) )

               CALL DPSTRF( AVDMAX, 14, 'F', HLPSTR )
               CALL REPMC ( INFMSG( 27 ), '#', HLPSTR, INFMSG( 27 ) )

               CALL DPSTRF( AVDMET, 14, 'F', HLPSTR )
