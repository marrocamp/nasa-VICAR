C$Procedure      ET2STR ( Convert ET to String for FRMDIFF Output )
      ...
      SUBROUTINE ET2STR ( ET, TIMFMT, SCLKID, STRING )
...
C
C        Output string should contain ET seconds. Use DPSTR.
C
         CALL DPSTR  ( ET, 14, STRING )
