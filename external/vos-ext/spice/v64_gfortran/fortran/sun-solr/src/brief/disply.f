C$Procedure DISPLY ( BRIEF Display Summary )
      ...
      SUBROUTINE DISPLY ( FMTPIC, TDSP,   GDSP, OBNAM, OBJLIS,
...
C
C     Are we going to group by window?  If not, this is pretty
C     easy.  Just display stuff.
C
      IF ( TDSP .AND. .NOT. GDSP ) THEN
