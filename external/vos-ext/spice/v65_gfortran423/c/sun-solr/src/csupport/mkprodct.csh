...
#   ===============
#
#   Version 5.1.0  Feb. 14, 2008  Boris Semenov
#
#      Added -KPIC option.
#
#   Version 5.0.0  Sep. 18, 2002  Boris Semenov
#
#      -fast optimization has been replaced with -O because -fast was 
#      generating broken code in unpredictable places.
#
#   Version 4.0.0  Feb. 04, 1999  Nat Bachman
#
...
if ( $status == 0 ) then
   ...
   foreach SRCFILE ( *.c )
      ...
      $COMPILER $TKCOMPILEOPTIONS $SRCFILE
   end
...
if ( $status == 0 ) then
   ...
   foreach MAIN ( *.px )
      ...
      if ( -e locallib.a ) then
         ...
         $COMPILER    $TKCOMPILEOPTIONS $TARGET
         $COMPILER -o $EXECUT           $MAINOBJ             \
                                        locallib.a           \
                                        ../../lib/csupport.a \
                                        ../../lib/cspice.a   \
                                        $TKLINKOPTIONS    
