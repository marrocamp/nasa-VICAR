...
/*!!!! THIS IS PROBABLY WRONG - the extra 1 should be an argument.  But */
/*!!!! that would have unknown effects.  Bug exists in all versions but */
/*!!!! only Mac complains about it.  rgd 2011/03/04.			*/

return( (PTR) OaReadSpectrumFromQube( (ODLTREE) *qube_node, *line, *sample, 1));
}
